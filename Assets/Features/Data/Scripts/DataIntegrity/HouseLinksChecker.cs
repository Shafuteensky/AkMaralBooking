...
{
    /// <summary>
    /// Проверяет связи дома: записи аренды, привязанные к нему
    /// </summary>
    public sealed class HouseLinksChecker : DataLinksChecker<HouseData>
    {
        /// <summary>Записи аренды этого дома</summary>
        ...
        protected override void PerformCheck(HouseData data)
        {
            ...
            foreach (ReservationData reservation in reservationsContainer.Data)
            {
                ...
                if (reservation.HouseId == data.Id)
